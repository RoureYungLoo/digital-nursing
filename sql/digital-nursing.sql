...
-- 菜单 SQL
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('护理计划和项目关联', '2010', '1', 'itemplan', 'nursing/itemplan/index', 1, 0, 'C', '0', '0', 'nursing:itemplan:list', '#', 'admin', sysdate(), '', null, '护理计划和项目关联菜单');
...
-- 按钮 SQL
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('护理计划和项目关联查询', @parentId, '1',  '#', '', 1, 0, 'F', '0', '0', 'nursing:itemplan:query',        '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('护理计划和项目关联新增', @parentId, '2',  '#', '', 1, 0, 'F', '0', '0', 'nursing:itemplan:add',          '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('护理计划和项目关联修改', @parentId, '3',  '#', '', 1, 0, 'F', '0', '0', 'nursing:itemplan:edit',         '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('护理计划和项目关联删除', @parentId, '4',  '#', '', 1, 0, 'F', '0', '0', 'nursing:itemplan:remove',       '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_by, create_time, update_by, update_time, remark)
values('护理计划和项目关联导出', @parentId, '5',  '#', '', 1, 0, 'F', '0', '0', 'nursing:itemplan:export',       '#', 'admin', sysdate(), '', null, '');